angular.module('phoenix.services', ['ngCordova'])
    .factory('DataService', function ($cordovaSQLite, $ionicPlatform, $q, $http, $ionicLoading) {
        ...
        function initDatabase() {
            ...
            var query_pa = 'CREATE TABLE IF NOT EXISTS param (id INTEGER PRIMARY KEY, code varchar(20), libelle varchar(60), pointvente_id varchar(20), prix float DEFAULT 0, transfert INTEGER DEFAULT 0, username varchar(60), gps varchar(60))';

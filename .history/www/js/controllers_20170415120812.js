angular.module('phoenix.controllers', [])
  ...
  .controller('LocationCtrl', function ($scope, $stateParams,$ionicLoading, $q, $cordovaGeolocation, GoogleMaps, $cordovaNetwork, $ionDrawerVerticalDelegate, $ionicSlideBoxDelegate, $ionicPlatform, ConnectivityMonitor, DataService, Marker) {

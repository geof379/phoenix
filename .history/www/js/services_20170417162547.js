angular.module('phoenix.services', ['ngCordova'])
    .factory('DataService', function ($cordovaSQLite, $ionicPlatform, $q, $http, $ionicLoading) {
        ...
        function initDatabase() {
            ...
            var query_pa = 'CREATE TABLE IF NOT EXISTS param (id INTEGER PRIMARY KEY, travel_mode varchar(20), preferred_distance INTEGER DEFAULT 0, username varchar(60), gps varchar(60))';
